...
{
	public string boolName;// 컨트롤할 Bool형 데이터 파라미터
	public bool updateOnState;// State에서 컨트롤 할 건지에 대한 여부
	public bool updateOnStateMachine; //StateMachine에서 컨트롤 할 건지에 대한 여부
